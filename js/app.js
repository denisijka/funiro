...
(() => {
  ...
  (t.prototype.init = function () {
    ...
    (t.prototype.moveTo = function (e, t, s) {
    ...
    (t.prototype.moveBack = function (e, t, s) {
  ...
  window.addEventListener("load", function (e) {
    fe(),
      ...
      document.querySelector(".slider-rooms") &&
        new ce(".slider-rooms", {
          modules: [ue, ge, me],
          observer: !0,
          observeParents: !0,
      ...
      document.querySelector(".slider-tips") &&
        new ce(".slider-tips", {
          modules: [ue, ge],
          observer: !0,
          observeParents: !0,
  ...
  it.length &&
    ...
    (window.onload = function () {
      document.addEventListener("click", function (e) {
        ...
        t.classList.contains("products__more") && (r(t), e.preventDefault());
        if (t.classList.contains("actions-product__button")) {
          const s = t.closest(".item-product").dataset.pid;
          !(function (e, t) {
            if (!e.classList.contains("_hold")) {
              ...
              n.setAttribute("class", "_flyImage -ibg"),
                (n.style.cssText = `\n\t\tleft: ${d}px;\n\t\ttop: ${l}px;\n\t\twidth: ${r}px;\n\t\theight: ${a}px;\n\t\t`),
                document.body.append(n);
              const c = s.getBoundingClientRect().top,
                p = s.getBoundingClientRect().left;
              (n.style.cssText = `\n\t\ttop: ${c}px;\n\t\tleft: ${p}px;\n\t\twidth: 0px;\n\t\theight: 0px;\n\t\topacity: 0;\n\t\t`),
                n.addEventListener("transitionend", function () {
                  e.classList.contains("_fly") &&
                    (n.remove(), o(e, t), e.classList.remove("_fly"));
                });
            }
          })(t, s),
            e.preventDefault();
        }
        t.classList.contains("cart-header__icon") ||
        t.closest(".cart-header__icon")
          ? (document.querySelector(".cart-list").children.length > 0 &&
              document
                .querySelector(".cart-header")
                .classList.toggle("_active"),
            e.preventDefault())
          : t.closest(".cart-header") ||
            t.classList.contains("actions-product__button") ||
            document.querySelector(".cart-header").classList.remove("_active");
        if (t.classList.contains("cart-list__delete")) {
          const s = t.closest(".cart-list__item").dataset.cartPid;
          o(t, s, !1), e.preventDefault();
        }
      });
      const t = document.querySelector(".furniture__body");
      if (t && !s.any()) {
        const e = document.querySelector(".furniture__items"),
          s = document.querySelectorAll(".furniture__column"),
          i = t.dataset.speed;
        let n = 0,
          r = 0;
        function o() {
        ...
        t.addEventListener("mousemove", function (e) {
          ...
          (r = (i / s) * 200),
            t.classList.contains("_init") ||
              (requestAnimationFrame(o), t.classList.add("_init"));
        });
      }
      const i = document.querySelector(".products__more"),
        n = document.querySelector(".products__items");
      async function r(t) {
        if (!t.classList.contains("_hold")) {
          t.classList.add("_hold");
          const s = "files/data/products.json";
          let i = await fetch(s, { method: "GET" });
          if (i.ok) {
            let e = await i.json();
            t.classList.remove("_hold"),
              t.remove(),
              (function (e) {
                e.products.length
                  ? e.products.forEach((e) => {
                      const t = e.id,
                        ...
                        c = e.likeurl,
                        p = e.labels;
                      let u = `<article data-pid="${t}" class="products__item item-product">`,
                        h = "</article>",
                        g = "";
                      if (p) {
